...
export default [
    new ProjectData("hipparcos", "Hipparcos", "img/projects/hipparcos-logo.jpg", 
    `
    <div class="paragraph">
     <strong>Hipparcos</strong> is a game I developed in 2024 in a team of 5 as part of the Design for Games & Play I course at TU/e.
    </div>
    ...
    `, "#2b2b2bff"),
    new ProjectData("stargone", "Stargone", "img/projects/stargone-icon.png", `
    <div class="paragraph">
    ...
    `, "#5a78af", false, true),
    new ProjectData("swage", "Swage", "img/projects/swage-icon.jpg", `
    <div class="paragraph">
